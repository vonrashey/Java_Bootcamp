...
public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
        ...
        boolean doesStarrWithPrefix = programming.startsWith("Java");
        System.out.println("Does it start with prefix? " +doesStarrWithPrefix);
        // Write your code here
        ...
        char oldChar = 'a';
        char newChar = 'o';
        String replacdedString = original.replace(oldChar, newChar);
        System.out.println(replacdedString);
        // Write your code here
        ...
        double power = Math.pow(exponent, base);
